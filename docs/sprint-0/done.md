...
| 3 - Hardening extractores | scripts/ todos ASCII-safe, xml trace.py usa CLI |
...
- `scripts/extract_*.py` y `scripts/xml trace.py` — ASCII-safe, CLI configurable
- `docs/ORQUESTACION-PBI-ORDS-REACT.md` — Fase 8 y 9 agregadas
...
Execute Sprint 1 following docs/ORQUESTACION-PBI-ORDS-REACT.md phases 5-9.
```
